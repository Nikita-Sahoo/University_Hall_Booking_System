    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="dropdown-container">
            <?php if ($user_role == 'admin'): ?>
                <a href="admin/add_hall.php" class="<?= ($currentPage == 'add_hall.php') ? 'active' : '' ?>">Add Hall</a>
            <?php endif; ?>
            <a href="admin/view_modify_hall.php" class="<?= ($currentPage == 'view_modify_hall.php') ? 'active' : '' ?>">View/Modify Hall</a>
            <?php if ($user_role == 'admin'): ?>
            <a href="admin/view_modify_achived_hall.php" class="<?= ($currentPage == 'view_modify_achived_hall.php') ? 'active' : '' ?>">Archive Halls</a>
            <?php endif; ?>
        </div>
        <button class="dropdown-btn">
            School/Departments
        ...
        <div class="dropdown-container">
            <?php if ($user_role == 'admin'): ?>
                <a href="admin/add_school_dept.php" class="<?= ($currentPage == 'add_school_dept.php') ? 'active' : '' ?>">Add School/Department</a>
            <?php endif; ?>
            <a href="admin/view_school.php" class="<?= ($currentPage == 'view_school.php') ? 'active' : '' ?>">View/Modify School</a>
        </div>
        <button class="dropdown-btn">
            Employee Details
            <i style="margin-left:20px;" class="fa fa-chevron-right"></i>
        ...
        <div class="dropdown-container">
            <?php if ($user_role == 'admin'): ?>
                <a href="admin/add_employees.php" class="<?= ($currentPage == 'add_employees.php') ? 'active' : '' ?>">Add Employee</a>
            <?php endif; ?>

            <a href="admin/view_employees.php" class="<?= ($currentPage == 'view_employees.php') ? 'active' : '' ?>">View Employees</a>
        </div>
